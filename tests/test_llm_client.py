...
class TestLLMClient:
    ...
    async def test_chat(self, client):
        ...
        with patch("landlord.llm_client.litellm.acompletion", new_callable=AsyncMock, return_value=mock_response):
    ...
    async def test_token_tracking_accumulates(self, client):
        ...
        with patch("landlord.llm_client.litellm.acompletion", new_callable=AsyncMock) as mock:
